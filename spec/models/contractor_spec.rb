...
describe 'a contractor' do 
  ...
  it "requires a name" do
    contractor = Contractor.new(contractor_attributes(name: ""))
    contractor.valid?
  ...
  it "accepts properly formatted names" do
  	...
  	names.each do |name|
	    contractor = Contractor.new(contractor_attributes(name: name))
	    contractor.valid?
  ...
  it "accepts properly formatted email addresses" do
    ...
    emails.each do |email|
      contractor = Contractor.new(contractor_attributes(email: email))
      contractor.valid?
